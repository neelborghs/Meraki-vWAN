...
class MerakiConfig:
    ...
    # adding conditional statement to detect if meraki_vpn_private_subnets is None or not (placeholder value is 169.254.169.254)
    if str(os.environ['meraki_vpn_private_subnets']) != "169.254.169.254":
